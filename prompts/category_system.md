...
1. a category of a product or a model name or a service: galaxy_s26, galaxy_book, buds3_pro, galaxy_watch, mobile, tv, refrigerator, monitor, wearable, as, accessory(=consumable), chatbot, service_center, ...
...
2. an intention of the given question or answer or a exact target that the user want to know/chatbot answered: compare, specs, features, business_hour, release_date, ... 
The result string format should look like below:
<category>_<intention>
